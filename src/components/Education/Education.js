...
function Education(props) {
    return (
        <section className="bg-gray-200 dark:bg-zinc-800">
            <div className="max-w-6xl px-6 pb-6 mx-auto bg-main-color">
                ...
                <div className='mx-6 grid grid-cols-1 divide-y divide-solid divide-black dark:divide-white'>
                    ...
                    <div  className='py-4 m-1 text-zinc-800 dark:text-gray-200'>
                        <h2 className='text-xl font-semibold inline capitalize lg:text-2xl'>BACHELOR</h2><h3 className='text-lg capitalize inline lg:text-xl'> - Universidade Federal De Uberlândia (2012-2019)</h3>
