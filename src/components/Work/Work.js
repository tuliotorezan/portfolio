            ...
            <div className='mx-auto mb-4 w-fit border-2 border-black dark:border-white'><h1 className='m-1 mx-2 text-2xl font-semibold text-zinc-800 capitalize lg:text-3xl dark:text-gray-200'>EXPERIENCE</h1></div>
                ...
                <ol className="relative border-l-4 border-zinc-700 dark:border-zinc-200">
                    <li className="mb-6 ml-6 ">
                        ...
                        <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Python</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Data Analysis</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Data Visualization</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Machine Learning</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Artificial Neural Networks</button>
                    </li>
                    <li className="mb-6 ml-6">
                        <span className="absolute flex items-center justify-center w-3 h-3 bg-white rounded-full mt-2 -left-2 ring-8 ring-zinc-700 dark:ring-zinc-200 dark:bg-zinc-800"/>
                        ...
                        <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">.NET</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">mySQL</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">HTML5</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">JavaScript</button>
                    </li>
                    <li className="mb-6 ml-6">
                        <span className="absolute flex items-center justify-center w-3 h-3 bg-white rounded-full mt-2 -left-2 ring-8 ring-zinc-700 dark:ring-zinc-200 dark:bg-zinc-800"/>
                        ...
                        <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">C#</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Arduino</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Data Analysis</button>
                    </li>
                    <li className="mb-6 ml-6">
                        <span className="absolute flex items-center justify-center w-3 h-3 bg-white rounded-full mt-2 -left-2 ring-8 ring-zinc-700 dark:ring-zinc-200 dark:bg-zinc-800"/>
                        <h2 className="flex items-center mb-1 text-xl font-semibold text-zinc-800 dark:text-white">Undergrad Research Assistant</h2>
                        ...
                        <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">C#</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Unity</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Data Analysis</button>
                    </li>
                    <li className="mb-6 ml-6">
                        <span className="absolute flex items-center justify-center w-3 h-3 bg-white rounded-full mt-2 -left-2 ring-8 ring-zinc-700 dark:ring-zinc-200 dark:bg-zinc-800"/>
                        ...
                        <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">C++</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Data Analysis</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Data Visualization</button>
                    </li>
                    <li className="mb-6 ml-6">
                        <span className="absolute flex items-center justify-center w-3 h-3 bg-white rounded-full mt-2 -left-2 ring-8 ring-zinc-700 dark:ring-zinc-200 dark:bg-zinc-800"/>
                    ...
                    <li className="mb-6 ml-6">
                        ...
                        <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">C#</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">Arduino</button>
                    </li>
                    <li className="mb-6 ml-6">
                        <span className="absolute flex items-center justify-center w-3 h-3 bg-white rounded-full mt-2 -left-2 ring-8 ring-zinc-700 dark:ring-zinc-200 dark:bg-zinc-800"/>
                        <h2 className="flex items-center mb-1 text-xl font-semibold text-zinc-800 dark:text-white">Undergrad Research Assistant</h2>
                        ...
                        <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">C#</button> <button class="bg-zinc-600 hover:bg-zinc-700 text-white pb-1 px-2 rounded-full">3D Modeling</button>
                    </li>
                </ol>
                </div>
            </div>
