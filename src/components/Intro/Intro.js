        ...
        <section className="bg-gray-200 dark:bg-zinc-800">
            <div className="max-w-6xl px-6 py-10 mx-auto">
                <main className="relative z-20 w-full mt-8 md:flex md:items-center xl:mt-12">
                    <div className="absolute w-full bg-main-color -z-10 md:h-96"></div>
                    <div className="w-full p-6 bg-main-color md:flex md:items-center md:bg-transparent md:p-0 lg:px-12 md:justify-evenly">
                        <img className="h-2 4 w-24 md:mx-6 object-cover shadow-md md:h-[32rem] md:w-80 lg:h-[22rem] lg:w-[26rem] " src="/me.jpeg" alt="client photo" />
